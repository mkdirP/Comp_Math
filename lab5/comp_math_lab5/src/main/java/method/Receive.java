...
public class Receive {
    ...
    // 接收给定的函数值
    public static double recX(double a, double b){
        double x = 0;
        while(true) {
            System.out.print("Please enter the X from [" + a +", " + b+"]\n> ");
            try{
                Scanner s = new Scanner(System.in);
                x = s.nextDouble();
                if (x < a || x > b){
                    System.out.println("\033[31m" + "Please enter X from [" + a +", " + b +"]!\n" + "\033[0m");
                }else return x;
            } catch (InputMismatchException ime){
                System.out.println("\033[31m" + "Please enter a number!\n" + "\033[0m");
            }
...
//            行数
            ...
            System.out.println("\033[31m" + "File not found, please re-enter the path!\n" + "\033[0m");
        } catch (IOException e){
